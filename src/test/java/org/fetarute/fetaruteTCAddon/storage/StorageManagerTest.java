...
final class StorageManagerTest {
    ...
    void selectSqliteDialectWhenConfigured() {
        ...
        StorageManager manager = new StorageManager(null, new LoggerManager(Logger.getAnonymousLogger()));
    ...
    void selectMysqlDialectWhenConfigured() {
        ConfigManager.StorageSettings settings = new ConfigManager.StorageSettings(
                ...
                new ConfigManager.SqliteSettings("data/test.sqlite"),
                Optional.of(new ConfigManager.MySqlSettings("127.0.0.1", 3306, "db", "user", "pwd", "fta_")),
                new ConfigManager.PoolSettings(5, 30000, 600000, 1800000)
        );
