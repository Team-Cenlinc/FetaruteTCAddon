 ...
 * <p>当前返回占位实现，确保命令层拿到明确的 StorageException，而不会静默空指针。</p>
 */
public final class StorageProviderFactory {
    ...
    public static StorageProvider create(ConfigManager.StorageSettings settings, StorageSchema schema, SqlDialect dialect,
                                         LoggerManager logger, File dataFolder) {
