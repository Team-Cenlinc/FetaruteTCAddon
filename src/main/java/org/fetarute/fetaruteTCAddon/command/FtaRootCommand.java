...
public final class FtaRootCommand implements CommandExecutor, TabCompleter {
  ...
  public List<String> onTabComplete(
    ...
    if (sender.hasPermission("fetarute.speed") || sender.hasPermission("fetarute.admin")) {
      options.add("speed");
    }
    ...
    if (sender.hasPermission("fetarute.train.config")
        || sender.hasPermission("fetarute.train.debug")
