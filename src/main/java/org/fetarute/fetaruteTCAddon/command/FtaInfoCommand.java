...
public final class FtaInfoCommand {
  ...
  public void sendHelp(CommandSender sender) {
    ...
    sendHelpEntry(
        sender,
        locale.component("command.help.entry-station"),
        ClickEvent.suggestCommand("/fta station "),
        locale.component("command.help.hover-station"));
    sendHelpEntry(
        sender,
    ...
    sendHelpEntry(
        sender,
        locale.component("command.help.entry-occupancy"),
        ClickEvent.suggestCommand("/fta occupancy "),
        locale.component("command.help.hover-occupancy"));
    sendHelpEntry(
        sender,
        locale.component("command.help.entry-spawn"),
        ClickEvent.suggestCommand("/fta spawn "),
        locale.component("command.help.hover-spawn"));
    sendHelpEntry(
        sender,
        locale.component("command.help.entry-speed"),
        ClickEvent.suggestCommand("/fta speed section "),
        locale.component("command.help.hover-speed"));
    sendHelpEntry(
        sender,
        locale.component("command.help.entry-eta"),
        ClickEvent.suggestCommand("/fta eta "),
        locale.component("command.help.hover-eta"));
    sendHelpEntry(
        sender,
        locale.component("command.help.entry-train"),
        ClickEvent.suggestCommand("/fta train "),
